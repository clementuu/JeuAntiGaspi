const AUDIO_PATHS = {
    theme: "assets/audio/15 - National Park.mp3",
    jukebox: "assets/audio/01 - The Pink Panther Theme.flac",
    collect: "assets/audio/mixkit-martial-arts-punch-2052.wav",
    footsteps: "assets/audio/FootSteps.wav",
    gasOn: "assets/audio/GasOn.wav",
    gasOff: "assets/audio/GasOff.wav",
    robinetOn: "assets/audio/RobinetOn.wav",
    robinetOff: "assets/audio/RobinetOff.wav",
    switch: "assets/audio/mixkit-light-switch-sound-2579.wav",
    fire: "assets/audio/campfireCrackles.wav",
    bathtub: "assets/audio/bathtub.wav",
    vinylStart: "assets/audio/VinylStart.wav",
    vinylStop: "assets/audio/VinylStop.wav",
};
